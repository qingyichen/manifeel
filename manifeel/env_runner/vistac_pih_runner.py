...
class ManifeelRunner(BaseImageRunner):
    ...
    def run(self, policy: BaseImagePolicy):
        ...
        while not done:
            ...
            if 'left_tactile_camera_taxim' in np_obs_dict:
                # print("left_tactile_camera_taxim shape: ", np_obs_dict['left_tactile_camera_taxim'].shape)
                # shape should be (batch, T, C, H, W), range [0, 1]
                data_temp = np_obs_dict['left_tactile_camera_taxim']
                
                # Ensure the data is in (batch, T, C, H, W) format
                ...
                np_obs_dict['left_tactile_camera_taxim'] = resized_data
                # print("left_tactile_camera_taxim shape: ", np_obs_dict['left_tactile_camera_taxim'].shape)
